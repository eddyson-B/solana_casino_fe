...
function App() {
  ...
  // Simple fake jackpot data for UI
    ...
    <div className="app-root">
      ...
      <div className="app-shell">
        <div className="app-shell-inner">
          <TopNav onLaunch={() => setView('dashboard')} />
          {view === 'landing' ? (
            <LandingSection onLaunch={() => setView('dashboard')} />
          ) : (
            <Dashboard
...
interface DashboardProps {
  coinChoice: CoinChoice;
  setCoinChoice: (c: CoinChoice) => void;
        ...
        <div className="hero-grid">
          <div>
            ...
            <p className="hero-subtitle">
              Jackpot wheels and 50/50 coinflips powered by Solana. Built to showcase real-time
              game UX, wallet connections, and a clean casino dashboard.
            </p>
            ...
            <div className="hero-meta">
              <div className="hero-meta-item">
                <span className="hero-meta-value">~0.4s</span>
                <span className="hero-badge">Average confirmation</span>
              </div>
              <div className="hero-meta-item">
                <span className="hero-meta-value">Provably fair</span>
                <span className="hero-badge">Anchor + Solana VRF (design)</span>
              </div>
              <div className="hero-meta-item">
                <span className="hero-meta-value">Demo only</span>
                <span className="hero-badge">Non-production reference</span>
              </div>
            </div>
          </div>
  ...
  return (
    <div className="pane">
      ...
      <div className="jackpot-wheel">
        <div className="jackpot-strip">
          {['eddyson-b', 'guest_01', 'vip_whale', 'anon777', 'demo-dev'].map((name, index) => (
            <div
              key={name}
              className={`ticket ${index === 2 ? 'ticket-highlight' : ''}`}
            >
              {name}
            </div>
          ))}
      ...
      <div className="jackpot-cta">
        <div className="muted">
          Your win chance and entries will be calculated by the backend + contract; this UI just
  ...
  return (
    <div className="pane">
      <header className="pane-header">
        ...
        <span className="muted">Hook this up to the Anchor program + BE API.</span>
      </header>
      ...
      <div className="coinflip-grid">
        <div className="coin-card">
          ...
          <div className="coin-meta">
            ...
            <span>House edge, fees, and randomness would be enforced on-chain.</span>
          </div>
        </div>
        ...
        <div className="coin-scene">
          <motion.div
            ...
            transition={{ duration: isFlipping ? 1.1 : 0.55, ease: 'easeInOut' }}
          >
...
function AuthCard() {
  return (
    <div className="auth-card">
      ...
      <p className="small">
        Wallet connection is powered by Solana wallet adapter. Social login (Google via Privy) is
        planned at the BE layer using Privy JWT verification.
      </p>
      <div className="hero-cta">
      ...
      <p className="small">
        To hook up Privy, supply your `VITE_PRIVY_APP_ID` and wrap this UI with the Privy provider
        in `main.tsx`, then verify tokens in the backend.
      </p>
    </div>
  );
}
...
function LandingSection({ onLaunch }: LandingSectionProps) {
  return (
    <section className="pane">
      <div className="hero-grid">
        <div>
          ...
          <p className="hero-subtitle">
            This frontend is intentionally polished: layered gradients, motion, and a clear game
